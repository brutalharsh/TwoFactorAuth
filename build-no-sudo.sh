...
# This script builds the app and creates a DMG without requiring sudo
...
echo "✅ BUILD COMPLETE!"
echo "============================================"
echo "📍 App built at: ./TwoFactorAuth.app"
echo "📍 DMG available at: ~/Downloads/TwoFactorAuth.dmg"
echo ""
echo "To install the app to /Applications, run:"
echo "  sudo rm -rf /Applications/TwoFactorAuth.app"
echo "  sudo cp -R TwoFactorAuth.app /Applications/"
echo ""
echo "Or simply double-click the DMG in Downloads and drag the app to Applications!"
echo "============================================"